...
The diagrams carry the weight. Prose is sparse, plain, and uses the terms in `CONTEXT.md` and relevant ADRs without ceremony.
...
Plain English, concise, with architectural nouns and verbs grounded in `CONTEXT.md` and relevant ADRs. Concision is not an excuse to drift.
...
No hedging, no throat-clearing, no "it's worth noting that…". If a sentence could be a bullet, make it a bullet. If a bullet could be cut, cut it. Use `CONTEXT.md` terms before inventing new ones.
