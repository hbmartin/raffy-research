...
UPDATE "feedbackEvent" SET "payload" = '{}'::jsonb WHERE "payload" IS NULL;--> statement-breakpoint
...
UPDATE "internalNoteConfig" SET "metadata" = '{}'::jsonb WHERE "metadata" IS NULL;--> statement-breakpoint
...
UPDATE "providerCallbackEvent" SET "rawPayload" = '{}'::jsonb WHERE "rawPayload" IS NULL;--> statement-breakpoint
...
UPDATE "providerConfig" SET "config" = '{}'::jsonb WHERE "config" IS NULL;--> statement-breakpoint
...
UPDATE "searchResult" SET "rawPayload" = '{}'::jsonb WHERE "rawPayload" IS NULL;--> statement-breakpoint
...
UPDATE "searchResult" SET "metadata" = '{}'::jsonb WHERE "metadata" IS NULL;--> statement-breakpoint
...
UPDATE "sourceRecord" SET "rawPayload" = '{}'::jsonb WHERE "rawPayload" IS NULL;--> statement-breakpoint
...
UPDATE "sourceRecord" SET "metadata" = '{}'::jsonb WHERE "metadata" IS NULL;--> statement-breakpoint
...
UPDATE "sourceSummary" SET "inputMetadata" = '{}'::jsonb WHERE "inputMetadata" IS NULL;--> statement-breakpoint
...
UPDATE "sourceSummary" SET "outputPayload" = '{}'::jsonb WHERE "outputPayload" IS NULL;--> statement-breakpoint
...
UPDATE "weeklyReportSource" SET "metadata" = '{}'::jsonb WHERE "metadata" IS NULL;--> statement-breakpoint
...
UPDATE "workspace" SET "metadata" = '{}'::jsonb WHERE "metadata" IS NULL;--> statement-breakpoint
...
UPDATE "workspaceCompetitor" SET "metadata" = '{}'::jsonb WHERE "metadata" IS NULL;--> statement-breakpoint
...
UPDATE "workspaceKeyword" SET "metadata" = '{}'::jsonb WHERE "metadata" IS NULL;--> statement-breakpoint
...
UPDATE "workspaceSocialAccount" SET "metadata" = '{}'::jsonb WHERE "metadata" IS NULL;--> statement-breakpoint
